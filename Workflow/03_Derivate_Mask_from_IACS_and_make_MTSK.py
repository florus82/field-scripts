...
rasterize_lines(f'/data/{origin}fields/IACS/2_Lines/GSA-DE_{spat_temp_id}.gpkg', 
                vrt_path, 
                f'/data/{origin}fields/IACS/3_Rasterized_lines/GSA-DE_{spat_temp_id}_lines_touch_true.tif', all_touch=True)

rasterize_lines(f'/data/{origin}fields/IACS/2_Lines/GSA-DE_{spat_temp_id}.gpkg', 
                vrt_path, 
                f'/data/{origin}fields/IACS/3_Rasterized_lines/GSA-DE_{spat_temp_id}_lines_touch_false.tif', all_touch=False)

# make a crop mask
make_crop_mask(polygon_path, 
               f'/data/{origin}fields/IACS/3_Rasterized_lines/GSA-DE_{spat_temp_id}_lines_touch_true.tif', 
               vrt_path, 
               f'/data/{origin}fields/IACS/4_Crop_mask/GSA-DE_{spat_temp_id}_cropMask_lines_touch_true.tif')

make_crop_mask(polygon_path, 
               f'/data/{origin}fields/IACS/3_Rasterized_lines/GSA-DE_{spat_temp_id}_lines_touch_false.tif', 
               vrt_path, 
               f'/data/{origin}fields/IACS/4_Crop_mask/GSA-DE_{spat_temp_id}_cropMask_lines_touch_false.tif')
