...
def train(args):
    ...
    train_dataset = RocksDBDataset('/home/output/rocks_db/ES.db/train.db', transform=TrainingTransformS2(mode='valid'))
    train_loader = DataLoader(dataset=train_dataset, batch_size=batch_size,
                              shuffle=False, num_workers=4, pin_memory=True)

    valid_dataset = RocksDBDataset('/home/output/rocks_db/ES.db/valid.db', transform=TrainingTransformS2(mode='valid'))
