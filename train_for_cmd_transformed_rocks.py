...
def train(args):
    ...
    train_dataset = RocksDBDataset('/home/output/rocks_db/All_but_LU_transformed.db/train.db', transform=None)
    train_loader = DataLoader(dataset=train_dataset, batch_size=batch_size,
                              shuffle=False, num_workers=4, pin_memory=True)

    valid_dataset = RocksDBDataset('/home/output/rocks_db/All_but_LU_transformed.db/valid.db', transform=None)
    ...
    country = 'All_but_LU_transformed'
